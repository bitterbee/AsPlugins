...
public class CommandUtil {
    ...
    public static void runCommand(Project project, String cmd) {
        ...
        EEConsole.show(project, process, cmd);
    }
    ...
    public static String getPythonCommandPath(Project project) {
        return getCommandPath(project, "python");
    }

    public static String getGitCommandPath(Project project) {
        return getCommandPath(project, "git");
    }

    public static String getAdbCmd(Project project) {
        return getCommandPath(project, "adb");
    }

    private static String getCommandPath(Project project, String cmd) {
        String cmdPath = getInstallPath(project, cmd);
        if (TextUtils.isEmpty(cmdPath)) {
            cmdPath = ConfigUtil.getConfig(cmd);
        }
        return cmdPath;
    }
